$(document).ready(function() {
  ...
  // Otherwise if we have an author_id in our url, preset the movie select box to be our movie
  ...
  function getAuthors() {
    $.get("/api/Movies", renderAuthorList);
  }
  ...
  function createAuthorRow(movie) {
